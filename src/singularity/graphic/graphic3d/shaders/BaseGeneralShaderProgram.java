...
import singularity.graphic.graphic3d.ShaderData;
import singularity.graphic.graphic3d.ShaderProgram;
import singularity.graphic.graphic3d.Stage3D;

public class BaseGeneralShaderProgram extends ShaderProgram {
  ...
  public ShaderData<Texture> diffTexture = assignData(ShaderData.uniformTexture("u_texture", 0));
        ...
        new Pass(){
          ...
          Shader buildShd(int lights){
            return new SglShaders.SglShader(
                ...
                SglShaders.internalShaderDir.child("3d").child("standard_base_pass.frag")
            ){
              @Override
  ...
  @Override
  protected Shader setupShader() {
    return SglShaders.standardBase;
  }
