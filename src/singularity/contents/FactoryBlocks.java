    ...
    purifier = new NormalCrafter("purifier"){{
      ...
      draw = new DrawFrame<NormalCrafterBuild>(this){
        ...
        public int framesControl(int index, NormalCrafterBuild e){
          if(index == 1){
            return (int)(13*(e.progress%(13f/90))/(13f/90));
          }
          else return 0;
        }
      ...
      draw = new DrawFactory<>(this){
        ...
        
        {
          drawDef = entity -> {
            ...
            Draw.z(Layer.effect);
            Draw.rect(laser, entity.x(), entity.y(), 90 + entity.totalProgress * 1.5f);
            Draw.z(Layer.block);
            Draw.color();
            Draw.rect(rotator, entity.x(), entity.y(), 90 + entity.totalProgress * 1.5f);
